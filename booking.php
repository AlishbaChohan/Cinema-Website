...
<label for="seats"  class="form"> NUMBER OF SEATS:</label> <input type="number" id="seats" name="seats" min="0" max="11"> 
...
<input type="checkbox" id="terms" name="popcorn2"> <label for="terms" class="form"> I have read and agreed to terms and conditions.</label>


<input type="submit" name="BOOK!" value="NEXT!" style="background-color:#6E0709;color:white;height:40px;width:80px;">
</pre>
